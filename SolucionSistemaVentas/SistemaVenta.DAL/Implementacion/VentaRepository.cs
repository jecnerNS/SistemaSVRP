...
namespace SistemaVenta.DAL.Implementacion
{
    ...
    {
        private readonly BDsistemaContext _dbContext;

        public VentaRepository(BDsistemaContext dbContext) : base(dbContext)
        {
        ...
        public async Task<List<DetalleVenta>> Reporte(DateTime FechaInicio, DateTime FechaFin)
        {
            ...
            return listaResumen;
            //.ThenInclude(tdv => tdv.IdTipoDocumentoVentaNavigation) -- esto iba en la cuarta fila
