    ...
    public class CategoriaService : ICategoriaService
    {
        ...
        public async Task<Categoria> Crear(Categoria entidad)
        {
            try
            {
                ...
                if (categoria_creada.IdCategoria == 0)
                    throw new TaskCanceledException("No se pudo crear la Categoria amigue");
        ...
        public async Task<Categoria> Editar(Categoria entidad)
        {
            try
            {
                ...
                if(!respuesta)
                    throw new TaskCanceledException("No se pudo Modificar la Categoria amigue :c");
        ...
        public async Task<bool> Eliminar(int idCategoria)
        {
            try
            {
                ...
                if(categoria_encontrada == null)
                    throw new TaskCanceledException("La Categoria no existe bro :c");
